...
Garaż blaszany jest siódmym typem produktu i ma osobny renderer parametryczny: dach jedno- lub dwuspadowy, proceduralne przetłoczenia blachy, 1–2 bramy, 0–4 okna, drzwi, wiatę boczną, orynnowanie, kotwienie, napęd i opcjonalny filc antykondensacyjny. Limity liczby otworów są częścią wersjonowanej definicji pilota, a nie przyszłego planu SaaS. Wymiary, przekroje, kompatybilność, wyposażenie, ceny i BOM garażu pozostają danymi `demoOnly` do zatwierdzenia przez producenta.
