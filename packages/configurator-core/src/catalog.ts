...
export const productSeeds: ProductSeed[] = [
  ...
  },
  {
    definition: {
      ...
      profiles: [
        { id: "structural-post", label: "Słup konstrukcyjny", usage: "Podparcie pionowe konstrukcji", aMm: 140, bMm: 140, shape: "rectangular", demoOnly: true },
        { id: "frame-beam", label: "Belka ramy", usage: "Obwodowa rama dachu", aMm: 140, bMm: 180, shape: "rectangular", demoOnly: true },
        { id: "roof-sheet", label: "Blacha trapezowa", usage: "Nieruchome poszycie dachu", aMm: 200, bMm: 35, shape: "louvre", demoOnly: true },
      ],
      colors,
  ...
  },
  {
    definition: {
      ...
      profiles: [
        { id: "screen-cassette", label: "Kaseta screen", usage: "Osłona wału i tkaniny", aMm: 105, bMm: 105, shape: "rectangular", demoOnly: true },
        { id: "screen-guide", label: "Prowadnica ZIP", usage: "Boczne prowadzenie tkaniny", aMm: 25, bMm: 45, shape: "rectangular", demoOnly: true },
        { id: "screen-bottom", label: "Listwa dolna", usage: "Obciążenie dolnej krawędzi", aMm: 30, bMm: 20, shape: "rectangular", demoOnly: true },
      ],
      colors,
  ...
  },
  {
    definition: {
      ...
      profiles: [
        { id: "shutter-box", label: "Skrzynka rolety", usage: "Osłona wału i zwiniętego pancerza", aMm: 165, bMm: 165, shape: "rectangular", demoOnly: true },
        { id: "shutter-guide", label: "Prowadnica pancerza", usage: "Boczne prowadzenie rolety", aMm: 53, bMm: 22, shape: "rectangular", demoOnly: true },
        { id: "shutter-slat", label: "Profil pancerza", usage: "Poziomy profil osłony", aMm: 39, bMm: 8, shape: "louvre", demoOnly: true },
      ],
      colors,
  ...
  },
  {
    definition: {
      ...
      profiles: [
        { id: "awning-cassette", label: "Kaseta markizy", usage: "Osłona tkaniny i mechanizmu", aMm: 260, bMm: 140, shape: "rectangular", demoOnly: true },
        { id: "awning-front", label: "Belka przednia", usage: "Zamknięcie przedniej krawędzi tkaniny", aMm: 80, bMm: 50, shape: "rectangular", demoOnly: true },
        { id: "awning-arm", label: "Ramię składane", usage: "Podparcie wysuniętej markizy", aMm: 50, bMm: 30, shape: "rectangular", demoOnly: true },
      ],
      colors,
