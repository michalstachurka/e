...
function Line({
  ...
  return (
    <motion.p
      style={{ x, opacity }}
      className={`font-display text-[clamp(2.4rem,6.4vw,5rem)] leading-[1.06] tracking-[-0.015em] ${
...
/**
 * Scroll-pinned brand statement: three lines slide in from opposite sides
 * and lock into a single composed manifesto.
 */
export function Statement() {
  ...
  return (
    <section ref={ref} className="relative h-[260vh] bg-vn-bg">
